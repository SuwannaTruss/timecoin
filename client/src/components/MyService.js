...
export default function MyService() {
  ...
  const updateStatus = async (requestId, newStatus) => {
    try {
      ...
      const response = await axios.patch(`/requests/${requestId}`, {
        requestStatus
      }, {
        headers: {
          "x-access-token": localStorage.getItem("token"),
...
<h2 className="p-3">My service</h2>
      <div className="col mx-auto">
        <div className="bg-white shadow rounded overflow-hidden">
          ...
          <h4 className="m-5">You received {requestsCount} requests for this service</h4>
              ...
              <div className="col-md-3 ads back-container-service">
                ...
                <div>
                  ...
                  <div className="input-group mb-3">
                    ...
                    <textarea col="5" row="5" className="form-control">{request.storage}</textarea>
                  </div>
